...
public class EmailAdapter extends BaseListAdapter<Email, EmailAdapter.EmailViewHolder> {

    public EmailAdapter(Context context, List<Email> data) {
        super(context, data);
    ...
    @Override
    public EmailViewHolder onCreateViewHolder(View itemView) {
        return new EmailViewHolder(mContext, itemView);
    }

    class EmailViewHolder extends BaseListViewHolder<Email> {
        ...
        public EmailViewHolder(Context context, View itemView) {
